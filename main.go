...
import (
	...
	"github.com/orange-cloudfoundry/terraform-provider-credhub/resources"
	"io/ioutil"
	"os"
	"path/filepath"
	"strings"
...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"credhub_certificate": resources.LoadGenerateResource(&resources.GenerateCertificateResource{}),
			"credhub_password":    resources.LoadGenerateResource(&resources.GeneratePasswordResource{}),
			"credhub_rsa":         resources.LoadGenerateResource(&resources.GenerateRSAResource{}),
			"credhub_ssh":         resources.LoadGenerateResource(&resources.GenerateSSHResource{}),
			"credhub_user":        resources.LoadGenerateResource(&resources.GenerateUserResource{}),
			"credhub_generic":     resources.LoadGenerateResource(&resources.GenericResource{}),
		},

		DataSourcesMap: map[string]*schema.Resource{
			"credhub_generic":     resources.LoadDataSource(&resources.GenericDataSource{}),
			"credhub_value":       resources.LoadDataSource(&resources.ValueDataSource{}),
			"credhub_json":        resources.LoadDataSource(&resources.JsonDataSource{}),
			"credhub_password":    resources.LoadDataSource(&resources.PasswordDataSource{}),
			"credhub_certificate": resources.LoadDataSource(&resources.CertificateDataSource{}),
			"credhub_rsa":         resources.LoadDataSource(&resources.RSADataSource{}),
			"credhub_ssh":         resources.LoadDataSource(&resources.SSHDataSource{}),
			"credhub_user":        resources.LoadDataSource(&resources.UserDataSource{}),
		},
